    ...
    <>
      ...
      >
        <p className="text-muted-foreground text-base">
          imovie.dpdns.org is a free online movie and TV show streaming website that
          allows users to watch content sourced from third parties. imovie.dpdns.org
        ...
        <p className="text-muted-foreground text-base">
          imovie.dpdns.org has no control over the content quality, availability,
          copyright, legality or validity of the third party material viewed via
          the space. imovie.dpdns.org cannot be held responsible for any streaming
        ...
        <p className="text-muted-foreground text-base">
          The operators of imovie.dpdns.org make no warranties or representations
          ...
          imovie.dpdns.org, you agree that access is provided “as is” at your own
          risk.
        </p>
        <div className="text-muted-foreground text-base">
          <p>Copyright Infringement:</p>
          imovie.dpdns.org respects the intellectual property rights of others. Users
          are prohibited from using imovie.dpdns.org to engage in copyright
          infringement or the unauthorized distribution of copyrighted content.
          imovie.dpdns.org will promptly remove or disable access to any infringing
          content upon receipt of proper notification from the copyright holder.
        </div>
        <div className="text-muted-foreground text-base">
          <p>No Endorsement:</p>
          <p>
            The content accessible through imovie.dpdns.org does not constitute an
        ...
        <div className="text-muted-foreground text-base">
          ...
          <p>
            imovie.dpdns.org does not knowingly collect or distribute content
            considered obscene or harmful to minors as defined by applicable
            law. However, imovie.dpdns.org has no control over third party content and
            some material accessible through imovie.dpdns.org may be inappropriate for
        ...
        <div className="text-muted-foreground text-base">
          <p>No Warranties:</p>
          <p>
            imovie.dpdns.org provides access to third party content on an “as is”
        ...
        <div className="text-muted-foreground text-base">
          ...
          <p>
            In no event shall imovie.dpdns.org be liable for any direct, indirect,
            ...
            hold harmless imovie.dpdns.org and its operators from any claims arising
